...
#else
#include "dap_device.h" // Debug Unit Cortex-M Processor Header File
#endif
...
{
  strcpy(str, VENDOR_ID);
  return sizeof(VENDOR_ID) - 1;
}
...
{
  strcpy(str, PRODUCT_ID);
  return sizeof(PRODUCT_ID) - 1;
}
